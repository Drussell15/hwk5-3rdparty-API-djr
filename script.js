// variable for holding all time block text 9AM-5PM
var timeBlocksText = ["", "", "", "", "", "", "", "", ""];
//needed to access timeblcos for event delegations
...
function renderTimeBlocks() {
    ...
    for (var i = 0; i < 9; i++) {
        // sets a variable for time of current block rendered
        var time = i + 9;
        if (time > 12) {
            time -= 12;
        }
        ...
        // creates text area add classes, index and value
...
// adds event listener to save T-Block
...
// saves the loaded schedule to localStorage
